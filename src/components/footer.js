            ...
            <footer className="footer-section">
                <div className="footer-container footer-grid">
                    ...
                    <div className="footer-child footer-paragraph-info">
                        ...
                        <p>
                            Propeht Anthony Starnes loves to hear from readers. You can reach him via email. 
                    ...
                    <nav className="social-media-nav">
                        <ul>
                            ...
                            <li>
                                <a 
                                    target="_blank"
                                    href="https://www.goodreads.com/book/show/53218748-another-jesus-movement?from_search=true&from_srp=true&qid=qlvpo8cHcF&rank=1"
                                    rel="noreferrer">
                                    <FontAwesomeIcon 
                                        className='font-awesome'
                                        icon={faGoodreads} />
